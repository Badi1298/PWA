	...
	<div class="grid grid-cols-1 grid-rows-1 pb-6 h-full">
		<div class="relative flex flex-col">
			<VLazyImage
				...
				class="absolute right-6 top-0 w-[587px]"
			/>
			<section class="flex pl-14 pt-[76px]">
					...
					<div class="relative flex items-center gap-x-9 py-4 font-effra">
						...
						<div class="flex flex-col max-w-[312px]">
							<the-h2 class="text-electric-blue">
								EXBLIFEP<sup class="text-base">®</sup> is where microbiological<br />
								eradication* meets efficacy<sup class="text-[60%] font-extrabold -top-[0.45em]">1</sup>
							</the-h2>
